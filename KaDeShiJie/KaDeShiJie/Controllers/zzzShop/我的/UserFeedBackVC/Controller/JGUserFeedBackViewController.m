...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor =  [UIColor dc_colorWithHexString:@"#F6F7F8"];
    self.aView = [[UIView alloc]init];
    _aView.backgroundColor = [UIColor whiteColor];
    _aView.frame = CGRectMake(20, 84, self.view.frame.size.width - 40, 180);
    [self.view addSubview:_aView];
    [self setNavigationBarTitle:@"意见反馈" tintColor:[UIColor whiteColor]];
...
-(JGPlaceholderTextView *)textView{
    ...
    if (!_textView) {
        ...
        _textView.layer.borderColor = [UIColor colorWithRed:227/255.0 green:224/255.0 blue:216/255.0 alpha:1].CGColor;
...
- (UIButton *)sendButton{
    ...
    if (!_sendButton) {
        ...
        _sendButton.layer.cornerRadius = 25.0f;
        _sendButton.frame = CGRectMake(25, 384, self.view.frame.size.width - 50, 50);
        _sendButton.backgroundColor =  UIColor.mainColor;
