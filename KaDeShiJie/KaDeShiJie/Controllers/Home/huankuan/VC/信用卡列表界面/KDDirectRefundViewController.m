...
//    @"费率：1.25%（每1万元125元手续费）+1元/次";
    self.feilvtitleLbl.text = [NSString stringWithFormat: @"费率：%.3f%%（每1万元%.0f元手续费）+%@元/次",[SharedUserInfo.consumptionRate doubleValue],([SharedUserInfo.consumptionRate doubleValue])*100,SharedUserInfo.extraFee];
