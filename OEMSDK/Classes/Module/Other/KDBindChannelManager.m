...
//                            };
//        kWeakSelf(self);
//        [[MCSessionManager shareManager] mc_POST:@"/paymentgateway/isChannelBind" parameters:dic ok:^(NSDictionary * _Nonnull resp) {
//            //查询是否有多通道
...
//        return;
//    }
//    [[MCSessionManager shareManager] mc_POST:self.getSmsUrl parameters:[self getSameParamers] ok:^(NSDictionary * _Nonnull resp) {
...
-(void)confirmSms{
    ...
    [[MCSessionManager shareManager] mc_POST:confirmUrl parameters:dic ok:^(NSDictionary * _Nonnull resp) {
            [weakself saveSuccessJumpVC];
    }];
}
#pragma mark -----------------------多通道设置方法---------------------
