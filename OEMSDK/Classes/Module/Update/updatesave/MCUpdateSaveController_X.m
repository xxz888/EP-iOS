...
@interface MCUpdateSaveController_X ()<QMUITableViewDelegate, QMUITableViewDataSource>

@property(nonatomic, copy) NSMutableArray<MCProductModel *> *dataSource;
@end

@implementation MCUpdateSaveController_X
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    LXUpgradeCell *cell = [LXUpgradeCell cellFromTableView:tableView];
