...
//    [[MCSessionManager shareManager] mc_POST:@"/user/app/login" parameters:params ok:^(NSDictionary * _Nonnull okResponse) {
//        // 1.保存账号密码
...
{
    [[MCSessionManager shareManager] mc_POST:@"/user/app/register" parameters:params ok:^(NSDictionary * _Nonnull okResponse) {
...
+ (void)getBindCardSMS:(MCBankCardModel *)cardModel result:(GetBindCardSMSCallBack)callBack{
    ...
    [[MCSessionManager shareManager] mc_POST:@"/paymentgateway/topup/dy/bindCardMsg" parameters:params ok:^(NSDictionary * _Nonnull okResponse) {
//        if (callBack) {
